...
// path_to_lnbits, action_url, invoiceId, seconds
...
function stopTimer(){
  document.getElementById('invoicePic').src = path_to_lnbits
...
if(typeof(EventSource) !== "undefined" ) {
  var source = new EventSource( path_to_lnbits + "/assets/sse/pay-status.php"
      + "?invoiceId=" + invoiceId );
