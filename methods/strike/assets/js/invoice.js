...
// path_to_strike, action_url, invoiceId, seconds
...
function stopTimer(){
  document.getElementById('invoicePic').src = path_to_strike
...
if(typeof(EventSource) !== "undefined" ) {
  var source = new EventSource( path_to_strike + "/assets/sse/pay-status.php"
      + "?invoiceId=" + invoiceId );
